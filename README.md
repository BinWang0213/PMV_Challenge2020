...
* DRP Dataset: Experimental 3D Velocity Field in Random Sphere Packing `https://www.digitalrocksportal.org/projects/175`
* Paraview Dataset (replace file in `data` folder): https://doi.org/10.5281/zenodo.4437847
